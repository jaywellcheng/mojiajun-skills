...
def evolve(
    ...
    # Use LLM-as-judge metric for complex skills (falls back to keyword overlap on error)
    ...
    try:
        ...
        console.print(f"[yellow]GEPA not available ({e}), falling back to MIPROv2 + LLMJudge[/yellow]")
